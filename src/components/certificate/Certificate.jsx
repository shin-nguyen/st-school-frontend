        ...
        <div className='certificate-container'>
            <div className='certificate-content' id='content'>
                ...
                <div style={{ "display": "flex", "alignItems": "center" }}>
                    <span>Date:&nbsp;</span>
                    <span style={{ fontSize: '16px', fontWeight: '700' }}> {order?.createdTime}</span>
                </div>
                <div style={{ "display": "flex", "alignItems": "center" }}>
                    <span>Length:&nbsp;</span>
                    <span style={{ fontSize: '16px', fontWeight: '700' }}> {course?.duration} total hours</span>
                </div>
            </div>
            <div className='certificate-info'>
                <div style={{ fontSize: '20px', fontWeight: '700', marginBottom: '20px', "marginTop": "-8px" }}>
                ...
                <div style={{"marginTop": "50px"}}>
                    <div className='certificate-download-btn can-click' onClick={() => exportPDF()}>
