      ...
      <div className="row">
        <div className="col-sm-5 course-info mt-20">
          <div className="info-control">
            <label>Image:</label>
            <img
              className="w-and-h-95 course-image"
              src={course.image}
              alt=""
            />
          </div>
          ...
          <Link to={"/admin/quizzes/" + course.id + "/add"}>
            <div className="btn btn-success mb-10">Add Quiz</div>
          </Link>
        </div>
        <div className="col-sm-6 course-video-list">
          <div className="list-title">Video List</div>
          <button
            type="button"
            className="btn btn-primary btn-new topright"
            data-toggle="modal"
            data-target="#myModal"
          >
            New Video
            ...
            <div className="modal-dialog">
              <div className="modal-content">
                ...
                <div className="modal-body ">
                  <VideoForm onSubmit={(values) => handelSubmit(values)} />
                </div>
              </div>
            </div>
          </div>
