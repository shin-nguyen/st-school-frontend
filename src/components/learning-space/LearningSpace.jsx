...
const ListVideoItem = (props) => {
  ...
  return (
    <div className={"list_video_item can-click"} onClick={props.onClick}>
      <div
        className={
          props.activeStep ? " active-step" : `list_video_item-inner ${active}`
        }
      >
        <ListItem>
          <ListItemAvatar>
          ...
          <ListItemText
            primary={"Lesson " + index + ": " + props.name}
            secondary={generateTimeToString(props.duration)}
          />
        </ListItem>
      </div>
    </div>
...
const ChoosebarItem = (props) => {
  ...
  return (
    <div
      className={"choosebar__item" + (props.isStep ? " active-step" : "")}
...
const LearningSpace = () => {
  ...
  return (
    <div
      className={
        "learning-space body-content" +
        (step !== 0 ? " disabled-background" : null)
      }
    >
      ...
      <div className="content-wrapper">
        ...
        ></Backdrop>
        <div
          className={"content-container" + (step === 5 ? " prioritized" : "")}
        >
          <div className="video-wrapper">
            <div
              className="topleft can-click"
              onClick={() => {
                handleNextStep();
              }}
            >
                ...
                title={
                  <React.Fragment>
                    <Typography color="inherit">
                      Hi Boss, I'm your assistant - XyXy
                    </Typography>
            ...
            <div className={"btn-show show-" + !showPlaylist}>
              <i
                class="bx bx-lg bx-chevrons-left bx-fade-left-hover topright can-click"
            ...
            {order?.isComplete ? (
              <div className={step === 10 ? " active-step" : ""}>
                <Link to={"/certificate/" + order?.id}>
                  <ChoosebarItem title={"Get certificate"} />
                </Link>
              </div>
            ) : (
              <Tooltip title="You must complete the course and have a final test score of more than 8 marks!">
                <div
                  className={"disabled" + (step === 10 ? " active-step" : "")}
                >
                  <ChoosebarItem
                    title={"Get certificate"}
                    onClick={() =>
                      toastError(
                        "You must complete the course and have a final test score of more than 8 marks!"
                      )
                    }
                  />
                </div>
      ...
      <div
        className={
          ...
          showPlaylist +
          " " +
          (step === 2 || step === 3 || step === 4 ? " prioritized" : "")
        }
      >
        <div className="playlist-header">
          <span>{course.name}</span>
          <i
            className="bx bx-md bx-x-circle bx-burst-hover can-click mt_5-"
            onClick={() => setShowPlaylist(!showPlaylist)}
          ></i>
        </div>
        ...
        <div
          className={"playlist-content" + (step === 2 ? " active-step" : "")}
        >
          ...
          {order.progress == 100 ? (
            <div
              className={
                "list_video_item can-click" + (step === 4 ? " active-step" : "")
              }
            >
            ...
            <div
              className={
                "disabled list_video_item can-click" +
                (step === 4 ? " active-step" : "")
              }
            >
...
const step1Message =
  "Hi " +
  email +
  ". Welcome to ST-School! Before starting to study, let me take you on a tour to see what ST-School has to offer. ≧◠◡◠≦✌";
const step2Message =
  "Here is a list of all the lessons. You will very often interact here to transfer lessons and do homework >_<. You can also hide this list and open it when needed.";
const step3Message =
  "This is the first lesson for you, when you finish this lesson, I will tick 'Green tick' next to it to mark you have completed the lesson!";
const step4Message =
  "Let scroll to the bottom of the list. After you have finished all the lessons, you can take the final exam here.";
const step5Message = "All information about the course will be described here";
const step6Message =
  "This is where everyone can talk about the course. Let's learn together.";
const step7Message = "And don't forget to leave a review of the course here.";
const step8Message =
  "When studying, there will be many times when you want to take notes, at ST-School you won't need to waste paper and ink to do this.";
const step9Message =
  "Here are some ST-School tools to help you study better. Explore it, it will be very helpful.";
const step10Message =
  "Once you have completed the course and have a final test score of more than 8 marks, you can get a certificate of course completion here.";
const step11Message =
  "That is all. You can start studying already. Good luck with your studies. Bye.";
