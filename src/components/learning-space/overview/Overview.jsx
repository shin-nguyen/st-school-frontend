  ...
  return (
    <>
      <div className="course-detail">
        <div
          style={{ fontSize: "17px", fontWeight: "600", marginBottom: "10px" }}
        >
          <span>{course.about}</span>
        </div>
        <div
          style={{ fontSize: "15px", fontWeight: "300", marginBottom: "5px" }}
        >
        ...
        <div className="">
          ...
          <div
            className="course-detail-sub-content"
            dangerouslySetInnerHTML={{ __html: course.isFor }}
          ></div>
        </div>
        <hr />
        <div className="">
